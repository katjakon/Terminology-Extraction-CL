...
`python main.py candidates --stops data/stops_en.txt --min_count 4 acl_texts/ <your file name> NNS NN NNP`
...
__Example:__<br>
`main.py extract -a 0.5 -t 2 acl_texts data/candidates1.txt output/output1.txt`
...
__Example:__<br>
`main.py evaluate --extracted output/output1.txt --gold data/gold_terminology.txt --high 30`
